...
class edit_profile_form(forms.ModelForm):
    ...
    framework=forms.CharField(max_length=100,widget=forms.TextInput(attrs={'class':'form-control'}))
    ...
    class Meta:
        model = profile
        fields = ('skills', 'framework', 'education', 'phone', 'email', 'description','profile_pic', 'cover_pic')
